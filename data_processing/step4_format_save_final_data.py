...
saves to:
- "../final_data/comic_data.csv"

- "../final_data/tfidf_vectors.npz"
- "../final_data/tfidf_feature_names.txt"
...
def save_comic_data():
    ...
    df.to_csv("../final_data/comic_data.csv")
...
def save_word_data():
    ...
    sparse.save_npz("../final_data/tfidf_vectors.npz", tfidf_vectors)
    ...
    with open('../final_data/tfidf_feature_names.txt', 'w') as f:
