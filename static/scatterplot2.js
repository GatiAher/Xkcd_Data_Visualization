class Scatterplot extends Chart {
  ...
  draw(data) {
    let chart_obj = this;
    console.log("Here 1", chart_obj.div);
...
function brushended() {
  console.log("Here 2", scatterplot.div);

  let s = d3.event.selection;

  if (!s) {
      // if nothing selected, reset axes
      if (!scatterplot.idleTimeout) return scatterplot.idleTimeout = setTimeout(idled, scatterplot.idleDelay);
